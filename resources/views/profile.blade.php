...
<body class="min-h-screen flex flex-col">
    ...
    <header class="absolute top-0 w-full z-20 flex justify-between items-center p-6">
        ...
        <nav class="flex space-x-4 underline">
            <a href="#" class="text-gray-700 hover:text-gray-900 v> px-3 py-1 rounded text-sm">maintenance</a>
            <a href="#" class="text-gray-700 hover:text-gray-900 v> px-3 py-1 rounded text-sm">Me</a>
            <a href="#" class="text-gray-700 hover:text-gray-900 v> px-3 py-1 rounded text-sm">Home</a>
            <a href="#" class="text-gray-700 hover:text-gray-900 v> px-3 py-1 rounded text-sm">about</a>
            <a href="#" class="text-gray-700 hover:text-gray-900 v> px-3 py-1 rounded text-sm">payment</a>
        </nav>
    </header>
